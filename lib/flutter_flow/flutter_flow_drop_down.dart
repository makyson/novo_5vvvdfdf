...
class FlutterFlowDropDown<T> extends FormField<T> {
  ...
  final FormFieldValidator<T>? validator; // Adicionado o parâmetro validator
  ...
  FlutterFlowDropDown({
    ...
    this.labelText,
    this.labelTextStyle,
    this.validator, // Incluído o parâmetro validator
    FormFieldSetter<T>? onSaved,
    T? initialValue,
  }) : super(
    onSaved: onSaved,
    validator: validator, // Passando o validator para o construtor do FormField
    initialValue: initialValue,
    builder: (FormFieldState<T> field) {
      return _FlutterFlowDropDown<T>(
        field: field,
...
class _FlutterFlowDropDown<T> extends StatefulWidget {
  const _FlutterFlowDropDown({
    Key? key, // Adicionado o parâmetro 'Key? key'
    required this.field, // Adicionado o parâmetro 'field'
    this.controller,
    this.multiSelectController,
    this.hintText,
    this.searchHintText,
    ...
    this.labelText,
    this.labelTextStyle,
  }) : super(key: key); // Definindo 'key' do super construtor

  final FormFieldState<T> field; // Adicionado o parâmetro 'field'
  final FormFieldController<T?>? controller;
  final FormFieldController<List<T>?>? multiSelectController;
  final String? hintText;
  final String? searchHintText;
  ...
  @override
  _FlutterFlowDropDownState<T> createState() =>
...
class _FlutterFlowDropDownState<T> extends State<_FlutterFlowDropDown<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // Adicionando a mensagem de erro abaixo do widget
...
class FlutterFlowDropDown<T> extends StatefulWidget {
  ...
  final String? labelText;
  final TextStyle? labelTextStyle;
  final String? Function(T?)? validator; // tornando o validator opcional
